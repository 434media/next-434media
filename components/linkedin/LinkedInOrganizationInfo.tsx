  ...
  if (!organization) {
    return (
      <div className="p-4 rounded-xl bg-white border border-neutral-200">
        <p className="text-neutral-500 text-sm">No organization data available.</p>
      </div>
    )
  }

  return (
    <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-[#0077B5]/5 via-white to-white border border-[#0077B5]/20">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="px-2 py-0.5 rounded-full bg-[#0077B5]/10 text-[#0077B5] text-xs font-medium">
              Company
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm">
            ...
            {organization.industry && (
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-neutral-500">{organization.industry}</span>
              </div>
            )}
