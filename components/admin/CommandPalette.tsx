...
const STATIC_ITEMS: CommandItem[] = [
  ...
  },
  {
    id: "nav-inbox",
    label: "Inbox",
    hint: "Contact form inquiries needing reply",
    icon: Inbox,
    section: "Navigate",
    search: "inbox contact forms inquiries reply messages",
    run: (router) => router.push("/admin/inbox"),
  },
  {
    id: "nav-audiences",
    label: "Audiences",
    hint: "Newsletter, events, partner lists — campaign cohorts",
    icon: Megaphone,
    section: "Navigate",
    search: "audiences newsletter events lists campaigns mailchimp signups submissions",
    run: (router) => router.push("/admin/audiences"),
  },
