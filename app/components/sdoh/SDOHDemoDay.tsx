  ...
  return (
    <>
      <div className="w-full h-full">
        ...
        <div
          className="relative w-full h-full aspect-[4/5] overflow-hidden group cursor-pointer border border-neutral-200"
        ...
        >
          ...
          {/* Play button overlay - visible initially, hidden when modal opens */}
          {!isModalOpen && (
          ...
          >
            ...
            <button
              ...
              className={`absolute top-4 right-4 z-20 w-10 h-10 bg-white text-neutral-900 hover:bg-neutral-100 transition-colors duration-200 flex items-center justify-center ${
                showModalControls ? "opacity-100" : "opacity-0"
              }`}
            ...
            <div className="relative" style={{ aspectRatio: "16/9" }}>
              ...
              {/* Custom controls */}
              <div
                className={`absolute bottom-0 left-0 right-0 bg-neutral-900 p-4 z-10 transition-opacity duration-300 ${
                  showModalControls ? "opacity-100" : "opacity-0"
                }`}
              >
                {/* Progress bar */}
                <div className="mb-4">
                  <input
                    ...
                    style={{
                      ...
                      }%, #404040 ${modalDuration ? (modalCurrentTime / modalDuration) * 100 : 0}%, #404040 100%)`,
                    }}
                  />
                </div>
            ...
            {/* Video info */}
            <div
              className={`p-6 bg-neutral-900 border-t border-neutral-700 transition-opacity duration-300 ${
                showModalControls ? "opacity-100" : "opacity-0"
              }`}
            >
