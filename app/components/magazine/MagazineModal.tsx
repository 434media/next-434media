        ...
        >
          ...
          <div className="relative z-10 pt-28 md:pt-0">
            <button
              ...
              className="mt-28 md:mt-0 absolute top-2 right-2 md:top-4 md:right-4 bg-black text-white p-2 hover:bg-white hover:text-black transition-colors duration-300 border-2 border-black z-10 touch-manipulation"
