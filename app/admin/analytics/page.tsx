...
export default function UnifiedAnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/60 to-slate-900 text-white flex">
      ...
      <aside className="mt-20 md:mt-16 flex flex-col w-16 md:w-20 lg:w-64 border-r border-white/10 backdrop-blur-sm bg-black/30">
        ...
        <div className="mt-auto p-2 md:p-4 text-[9px] md:text-[10px] text-white/30 hidden lg:block">© {new Date().getFullYear()} 434 MEDIA</div>
      </aside>
      {/* Content */}
