                ...
                {paginatedData.length === 0 ? (
                  ...
                  paginatedData.map((speaker) => (
                    <tr key={speaker.id} className="hover:bg-neutral-50 transition-colors group">
                        ...
                        <button onClick={() => setDetailSpeaker(speaker)} className="text-left">
                          <div className="flex items-center gap-3">
                            {(speaker.photo || speaker.headshot) ? (
                              ...
                              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-50 to-purple-50 border border-neutral-200 flex items-center justify-center">
                      ...
                      <td className="px-4 py-3 text-neutral-600 truncate max-w-[160px]">{speaker.title || "—"}</td>
                      <td className="px-4 py-3 text-neutral-600 truncate max-w-[140px]">{speaker.company || "—"}</td>
                      <td className="px-4 py-3">
                  ...
                  <div className="p-4">
                    <div className="flex items-start gap-3">
                      {(speaker.photo || speaker.headshot) ? (
                        ...
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center border border-neutral-200">
