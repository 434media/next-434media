...
export default function InsertDataPage() {
  ...
  return (
    <>
      ...
      {authenticated && (
        <div className="container mx-auto py-10 px-4 sm:px-6 mt-24 md:mt-16">
              ...
              >
                <Card className="mb-8 border-yellow-300 overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    <p className="mb-4">
                      You need to create the database tables before you can upload analytics data. Click the button
                      below to initialize the database.
                    </p>
                    <Button
                ...
                <Card className={`overflow-hidden ${uploadResult.success ? "border-green-300" : "border-red-300"}`}>
                  ...
                  <CardContent className="pt-6">
                    {uploadResult.success ? (
                      <div className="space-y-4">
                        <p>
                          Successfully processed {uploadResult.recordsProcessed} records of {uploadResult.dataType}{" "}
                          data.
                        </p>
                        ...
                        {uploadResult.results && (
                          <div className="space-y-2">
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                              ...
                              {uploadResult.results.pageViews > 0 && (
                                <li>Page Views: {uploadResult.results.pageViews}</li>
                              )}
                              ...
                              {uploadResult.results.summary > 0 && (
                                <li>Summary Records: {uploadResult.results.summary}</li>
                              )}
                            </ul>
