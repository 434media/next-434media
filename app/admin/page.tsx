...
const adminSections: AdminSection[] = [
  ...
  },
  {
    ...
    delay: 0.1,
    size: "large",
    description: "View comprehensive website analytics, traffic sources, and user behavior data directly from Google Analytics 4",
  },
  {
    ...
    delay: 0.15,
    size: "large",
    description: "Monitor Instagram performance, engagement metrics, and audience insights directly from Meta Insights",
  },
  {
    id: "analytics-mailchimp",
    title: "MAILCHIMP ANALYTICS",
    subtitle: "Email Marketing Insights",
    href: "/admin/analytics-mailchimp",
    icon: <MailchimpIcon className="w-8 h-8" />,
    delay: 0.175,
    size: "large",
    description: "Track email campaign performance, subscriber growth, and engagement metrics directly from the Mailchimp API"
  },
  {
    id: "blog-admin",
    title: "BLOG ADMIN",
