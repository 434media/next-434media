...
const adminSections: AdminSection[] = [
  ...
  },
  {
    ...
    title: "MAILCHIMP INSIGHTS",
    subtitle: "Mailchimp Analytics Dashboard",
    href: "/analytics-mailchimp",
    icon: <MailchimpIcon className="w-8 h-8" />,
    delay: 0.2,
    size: "large",
    description: "Analyze email campaign performance, subscriber growth, and engagement metrics",
  },
  {
    id: "blog-admin",
    title: "BLOG ADMIN",
