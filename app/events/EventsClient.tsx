          ...
          >
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mb-8 sm:mb-10">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-ggx88 font-black leading-[0.92] tracking-tighter mb-4 sm:mb-6">
              ...
              <div className="mb-10 sm:mb-12">
                <p className="text-lg md:text-xl text-neutral-300 leading-relaxed tracking-wide font-normal max-w-2xl mx-auto">
              ...
              <div className="mb-6" id="events-list-section">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6">
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-ggx88 font-black text-black mb-3 flex items-center gap-3 tracking-tighter leading-tight">
              ...
              <div className="space-y-3 sm:space-y-4">
                {isLoading ? (
                  ...
                  <div className="text-center py-20">
                    ...
                    <p className="text-neutral-500 text-base leading-relaxed max-w-sm mx-auto font-normal">
